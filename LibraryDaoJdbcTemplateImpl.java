...
public class LibraryDaoJdbcTemplateImpl implements LibraryDao {
    ...
    // String constants for prepared statements for authors
    ...
    // String constants for prepared statements for books
    ...
    // String constants for prepared statements for publishers
    ...
    private void insertBooksAuthors(Book book) {
        ...
        for (Author currentAuthor : authors) {
            jdbcTemplate.update(SQL_INSERT_BOOKS_AUTHORS, bookId, 
    ...
    public void deleteBook(int bookId) {
        // delte books_authors relationship for this book
    ...
    public List<Book> getBooksByPublisherId(int publisherId) {
        ...
        List<Book> bookList = jdbcTemplate.query(SQL_SELECT_BOOKS_BY_PUBLISHER_ID,
